...
var getIn = function getIn2(state, complexKey) {
  ...
  for (var i = 0; i < path.length; i++) {
    var key = path[i];
    if (current === void 0 || current === null || typeof current !== "object" || Array.isArray(current) && isNaN(Number(key))) {
      return void 0;
    }
    current = current[key];
  }
...
function createForm(config) {
  ...
  var scheduleAsyncCallbacks = function scheduleAsyncCallbacks2() {
  ...
  var executeCallback = function executeCallback2(callback, isAsync) {
    if (isAsync) {
...
var ReactFinalFormContext = React.createContext(void 0);
...
function useFormState(_temp) {
  ...
  React.useEffect(function() {
    var unsubscribe = form.subscribe(function(newState) {
      setState(function(prevState) {
        if (!shallowEqual3(newState, prevState)) {
...
var defaultFormat = function defaultFormat2(value, _name) {
  return value === void 0 ? "" : value;
};
var defaultParse = function defaultParse2(value, _name) {
  return value === "" ? void 0 : value;
};
...
function useField(name, config) {
    ...
    if (existingFieldState) {
      if (allowNull && existingFieldState.initial === null && existingFieldState.value !== null) {
        return _extends({}, existingFieldState, {
          ...
          initial: null
          // Ensure our local state's 'initial' also reflects this
        });
      }
      return existingFieldState;
    }
    var initialStateValue = initialValue;
    if (component === "select" && multiple && initialValue === void 0) {
      initialStateValue = [];
    }
    return {
      active: false,
  ...
  var getInputValue = function getInputValue2() {
    ...
    if ((type === "checkbox" || type === "radio") && _value !== void 0) {
      return _value;
    }
    return value;
  };
  var getInputChecked = function getInputChecked2() {
    var value = state.value;
    if (type === "checkbox") {
      value = format(value, name);
      if (_value === void 0) {
...
function FieldComponent(_ref, ref) {
  ...
  if (typeof component === "string") {
    ...
    return React.createElement(component, _extends({}, inputProps, {
      children,
      ref
    }, rest));
  }
...
var Field = React.forwardRef(FieldComponent);
function withTypes() {
  return {
    Form: ReactFinalForm,
    FormSpy
