  ...
  return (
    <>
      {product.stock > 0 ?
        ...
        <div className={"flex justify-end mr-4"} onClick={() => {
          addToCart(product)
        }}>
          <div
        ...
        <div>
          Out Of Stock
          (update this later to feature a similar looking div as the one above and featuring a text div in the center that says out of stock)
        </div>
      }
    </>
  )
